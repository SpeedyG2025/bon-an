...
const TRANSLATIONS = {
  ...
  donate: {
    ...
    thanks_p:   { fr:"La santé mentale est un droit fondamental. En soutenant CAPSY, vous participez à la reconstruction du tissu social d'Haïti.", ht:"Sante mantal se yon dwa fondamantal. Lè w sipòte CAPSY, ou patisipe nan rekonstriksyon tisi sosyal Ayiti.", en:"Mental health is a fundamental right. By supporting CAPSY, you contribute to rebuilding Haiti's social fabric.", es:"La salud mental es un derecho fundamental. Al apoyar a CAPSY, participa en la reconstrucción del tejido social de Haití." },
    modal_icon: "❤️",
